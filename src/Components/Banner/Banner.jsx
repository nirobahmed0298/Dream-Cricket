...
const Banner = () => {
    return (
        <div className='my-5'>
            <div className='rounded-xl h-[100vh] py-64 bg-black flex items-center justify-center' style={{backgroundImage:`url(${banner})`}}>
                <div className='text-white text-center space-y-3'>
                    ...
                    <button className='btn bg-[#E7FE29] border-4'>Claim Free Credit</button>
                </div>
            </div>
        </div>
    );
